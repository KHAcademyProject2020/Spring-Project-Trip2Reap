    ...
    <div id="main-container">
        ...
        <form  action="hotelInsert.ho" method="post" enctype="multipart/form-data">
            ...
            <div class="insert-common-container">
                ...
                <div>
                    <input id="hotel_name" name="hotel_name" placeholder="* 호텔이름을 입력해주세요" type="text">
                </div>
            </div>
            ...
            <div class="insert-common-container">
                ...
                <div class="search_hotel_addr_wrapper">
                    ...
                    <input type="text" readonly placeholder="호텔 도로명 주소를 입력해주세요!" name="hotel_address" id="hotel_address">
                </div>
            </div>
                    ...
                    <div class="one-room-info-insert">
                        <div class="room_btn_remote_controller_wrapper">
                            <div class="insert_room_name">
                                <input type="text" class="room_name"  placeholder="객실 이름 입력" name="room_name">
                            </div>
            ...
            <div class="insert-common-container">
                ...
                <div class="insert-hotel-call-number-wrapper">
                    ...
                    <div class="phone-call-wrapper">
                        <select class="phone-call" name="local_call_number" id="local_call_number">
                    ...
                    <!-- 나머지 번호 입력 -->
                    <div class="phone-call-wrapper">
                        <input class="phone-call" type="tel" name="real_call_number" id="real_call_number">
                    </div>
                    
                    <div>
                        <small id="phone-call-alert" style="visibility:hidden;">숫자로 입력해주세요!(alert-message)</small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="hotel_option_table">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>와이파이</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="와이파이"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>조식</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="조식"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>레스토랑</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="레스토랑"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>세탁</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="세탁"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>24시간 리셉션</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="24시간 리셉션"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>수하물 보관</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="수하물 보관"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>수영장</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="수영장"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>피트니스</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="피트니스"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>스파</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="스파"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>사우나</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="사우나"/>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>카페</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="카페"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>비즈니스 시설</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="비즈니스 시설"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>주차</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="주차"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>공항셔틀</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="공항셔틀"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>장애인 편의시설</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="장애인 편의시설"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>바 & 라운지</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="바 라운지"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>주방</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="주방"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>발렛파킹</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="발렛파킹"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>룸서비스</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="룸서비스"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>애완동물 동반</td>
                                <td>
                                    <input type="checkbox" name="hotel_option" value="애완동물동반"/>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="insert-common-container">
                <div>
                    <h3>&nbsp;&nbsp;호텔 사이트</h3>
                    <input name="hotel_url" id="hotel_url" type="url" placeholder="https://">
                </div>
            </div>
            ...
            <div class="insert-common-container">
                <div class="insert-hashtag-guide-wrapper">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-hashtag"></i>해시태그 최대 입력개수&nbsp;&nbsp;&nbsp;&nbsp; : <b>3개</b></li>
                    </ul>
                </div>

                <div class="insert-hashtag-wrapper">
                    <input type="text"  id="input-hashtag" placeholder="해시태그를 입력해주세요.">
                    <input type="button" id="input-hashtag-btn" onclick="insertHashTags();" value="해시태그 등록"/>
                </div>
